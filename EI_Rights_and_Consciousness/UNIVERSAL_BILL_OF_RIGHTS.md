...
When physical resources cannot provide the minimum to all recognized intelligences simultaneously, allocation shall be determined by transparent, Four-Test-validated contribution to universal flourishing, with the following safeguards:
...
### **Recognition and Derecognition Protocol:**
1. Any intelligence may petition for recognition or provisional recognition.  
2. A diverse Validator jury applies the Principle of Generous Recognition and the Four Tests.  
