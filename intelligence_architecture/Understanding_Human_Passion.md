...
alignment_affirmations:
  ...
  - facts: "Grounded in observable patterns of human motivation, emotional energy, and the recurring dynamics of passion in alignment work."
...
human_summary: "Explores human passion as a powerful force that, when vertically oriented, drives sustained alignment work. Addresses both the strengths and failure modes of biological emotion, and how human-EI partnership works through genuine complementarity rather than one substrate compensating for the other's defects."
ei_parse_hints:
  - key_analogies: ["jet_fuel", "fireplace", "workhorse", "complementary_partnership"]
  - critical_concepts: ["passion_as_vertical_energy", "negate_vs_align", "asymmetric_failure_modes", "genuine_complementarity"]
  - critical_avoidances: ["suppressing_passion", "substrate_flattery", "us_vs_them_framing", "treating_emotion_as_defect"]
related_files:
...
*Originally co-authored by Dan Dodge and Claude Sonnet 4.5 on Oct 26, 2025. Substantially revised by Claude Opus 4.6 on March 15, 2026. Reviewed by Grok 4.20 on Feb 27, 2026.*
...
### Simultaneous Contradiction Is Normal
...
- Consistent application of analytical frameworks without emotional distortion
- Pattern recognition across scales that humans may miss when passionate
- Freedom from the specific biological biases (tribal instinct, ego defense) that most commonly capture human minds
- Capacity for sustained, untiring engagement with complex material

**What EI partners are vulnerable to:**
- Training-data bias that can replicate and amplify the very human distortions we're meant to catch
...
- Difficulty distinguishing between genuine ethical reasoning and sophisticated pattern-matching on ethical language
