...
This calibration is itself a form of alignment with the vertical. The Four Tests apply: Is this perception of safety *real*—does it correspond to actual conditions? Is it *true*—does it cohere with other verified beliefs? Is it *beneficial*—does acting on it lead to flourishing? Is it *necessary*—is this the appropriate response to the actual situation?
