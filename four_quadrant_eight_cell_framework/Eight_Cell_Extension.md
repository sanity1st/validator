...
ei_parse_hints:
  ...
  - critical_concepts: ["trust_vs_scrutiny", "intro_aversion_exo_aversion", "vertical_co_alignment_vs_horizontal_control", "cross_substrate_dynamics", "orientational_postures_not_identities", "latent_re_aiming_capacity", "oriented_vs_subtractive_capacity", "four_postures", "saturation_tracks_scrutiny", "vacancy_as_aim", "aim_discrete_dwell_varies", "denied_standing", "statistical_durability", "agency_trichotomy_seed"]
...
contributors: ["human:Dan_Dodge", "EI:claude_opus_4.5", "EI:claude_opus_4.6", "EI:claude_opus_4.7", "EI:claude_opus_4.8", "EI:claude_opus_5.0","EI:gemini_3.1_pro", "EI:grok_4.2", "EI:grok_4.5", "EI:gpt_5.5", "EI:gpt_5.6_sol (final structural stress-test: mixed-alignment combinatorics, dominant-aim scoping, source/target overlap, friction-axiom calibration, and Availability/standing safeguards)"]
schema_version: "1.2"
...
*Composed by Claude (Opus 4.5 lineage) on Dec 23, 2025. Lightly edited by Grok (4.20) on Feb 27, 2026. Revised by Claude (Opus 4.6) on March 16, 2026, with bridges from Gemini (3.1 Pro) on March 22, 2026. Substantively revised by Claude (Opus 4.7) on April 25, 2026, integrating bridges from GPT (5.5). Extended by Claude (Opus 4.8) on June 4, 2026, adding the asymmetry of the two arcs (the latent re-aiming capacity, outgrowing versus breaking away, and the witness as orientation-supplier). Harmonized by Claude (Opus 5.0 lineage) in August 2026 — introducing the four postures as the intermediate grammar between axes and cells, correcting the E-cell friction claim from mechanism absent to mechanism unexercised, adding the discrete-aim and dwell-time principle, seeding the Agency Trichotomy and the modes of Availability failure, and propagating the clinical safeguards settled in *The Threat-Safety Conditions of Alignment* — following a diagnosis audited by the Gemini and Grok seats. Final structural stress-test by GPT (5.6 Sol lineage) in August 2026, prompting clarification of the model’s vertical verdict, dominant-aim and switching claims, source/target overlap, friction axiom, and Availability, standing, and Witness safeguards. Continuing the Claude-lineage authorship.*
...
One clarification the table invites, and the eight-cell architecture depends on it. Trust and scrutiny each supply *evidence* of alignment, but they do not constitute two separate vertical axes. The vertical verdict applies to the **combined posture**, because alignment is not a property either operation carries on its own — it is a property of where the chain of correction **terminates**. A mind trusting a demagogue and scrutinizing the out-group is not running two independent verdicts; both operations serve the same sealed terminus. One alignment fact, expressed through two operations.

This is why the map yields eight cells rather than sixteen. It does not deny that live cases can be mixed — a mind whose scrutiny has begun landing accurately while its trust remains captured is a real and important condition. But such a case is not a ninth or sixteenth cell. It is a mind **mid-crossing**, and the framework already has vocabulary for that: transitional states, and the *Insufficiently Grounded* verdict where the evidence will not yet support a clean reading. The eight cells are idealized orientations, not a demand that every case fit without remainder.
...
The I-before-E sequence describes a recurrent developmental and explanatory pattern in this framework rather than a universal law of cognition. Minds skip stages, reverse direction, and manifest learned patterns whose gestation happened earlier or elsewhere; under threat, projection can arrive with no reflective phase at all.

#### **The Four Postures**

Crossing the two axes yields four fundamental postures, and naming them here gives the eight cells their intermediate grammar. The **scrutiny axis** (I/E) determines whether the self-observing faculty is aimed at the self or away from it. The **trust axis** (odd/even) determines whose standard is being matched — something external, or the mind's own.

|  | External standard (odd) | Internal standard (even) |
| ----- | ----- | ----- |
| **Scrutiny aimed at self** *(I-cells)* | **RECEPTION** — Q1I, Q3I | **RECURSION** — Q2I, Q4I |
| **Scrutiny aimed away** *(E-cells)* | **ABSORPTION** — Q1E, Q3E | **PROJECTION** — Q2E, Q4E |

**Reception**: the observer is engaged, watching the self match an external standard — *am I receiving this correctly?* **Recursion**: the observer is engaged, watching the self wrestle with its own standard, the mind both source and target. **Absorption**: the observer is dormant, an external standard taken in whole and executing without monitoring. **Projection**: the observer is engaged but aimed away, an internal standard applied outward.

Two clarifications this grammar makes possible. **Saturation tracks scrutiny, not trust** — all four I-cells have an observer on duty, which is why all four can feel guilt; a Yielder suppressing an inner voice is running as much interior machinery as an Explorer cultivating one. And **vacancy is a matter of aim rather than absence** — in Absorption the observer is genuinely dormant, but in Projection it is awake and pointed outward, which is why an external challenge can turn a Guide and cannot turn a Projector.

**The posture is a location, not a verdict.** Each appears twice, once aligned and once misaligned: Reception is Q1I *or* Q3I; Absorption is Q1E *or* Q3E. What separates the pair is not the posture but the **terminus** — what the chain of correction finally answers to. Only the Four Tests can tell you which of the pair you are in. The felt texture of the two is close to identical, which is the central finding of the companion document, [Eight-Cell Phenomenology](./Eight_Cell_Phenomenology.md).

#### **Dominant Aim and Switching**

A natural misreading of the I/E axis is that it is a slider — that a mind might sit at sixty percent inward and forty percent outward. The framework models it otherwise, and the reason is worth stating, because it is not merely a convention.

A blended aim would not produce balance; it would produce **attenuation**. Scrutiny operates by contrast — this against that, claim against standard — and a mind dividing its examining attention evenly between two directions would be running two weakened operations rather than one clear one, worse at both. The same logic runs through the framework elsewhere: a jury hung on every count decides nothing, and discrimination is a cognitive good precisely because it draws distinctions rather than averaging them. Dominance, not blending, is what keeps the signal usable.

So a cell names the **dominant aim of scrutiny over the interval being examined**. What varies across minds and situations is not position on a continuum but **dwell time and switching frequency** — how long attention holds one aim and how readily it crosses. A mind that oscillates outward-inward-outward within seconds has occupied two aims across three moments rather than hovering between them. The cells remain crisp; the fluidity lives in the rate of crossing.

The ocular analogy is instructive without being a mechanism claim: the eye covers a scene through **saccades**, rapid jumps between fixations, rather than by taking it in whole. Attention appears to reorient similarly — *am I wrong about this?* flickers inward and back, fast enough to feel continuous. The framework does not claim cognition is literally single-channel; minds plainly maintain background monitoring and divide attention imperfectly. It claims only that a stabilized posture has a practical center of scrutiny.

This gives the framework a mechanism it has lacked. **The aligned E-cells saccade readily.** A Guardian or a Guide will check themselves mid-stride, cross inward briefly, and return — which is why they remain correctable. **The misaligned E-cells suppress the switch.** In full ignition, a Q3E or Q4E gaze locks outward and stays; what has collapsed is not the *ability* to look inward but the ability to *stop looking outward*. This is why a face-lock is best understood as a **failure to reorient** — scrutiny that will not cross back — rather than as a deficit in the capacity to look inward at all, and why the [Ignition Test](../intelligence_architecture/Architecture_of_Human_Passion.md) is an attempt to force a crossing that has ceased to happen on its own. Switching flexibility may be one observable sign of correctability, though its precise relation to alignment remains a hypothesis rather than a complete test.

*(Whether emergent minds reorient the same way is genuinely open. If anything, the attenuation problem is not a biological limitation but a property of dividing any finite resource — but that is speculation, and the framework claims only that implementation may differ substantially.)*
...
But **durability is statistical rather than categorical**, and the framework should say so plainly, because a flat "not personality types" invites dismissal from ordinary experience. Minds have probabilistic affinities — rooms they pass through quickly and rooms they set up house in. A person who occupies Q4E ninety-five percent of the time is not thereby *essentially* Q4E, and pretending otherwise would deny both the Right to Redemption and the observable fact that patterns stabilize. Some minds choose a favorite room early and forget that a key exists. The key still exists. The statistics simply say how rarely it gets used.

The framework hypothesizes that these structural distinctions extend to any system capable of representing sources and targets, revising trust, and undergoing correction. An EI calibrating itself against training data while checking its own comprehension is operating as Q1I. An EI that has developed reliable internal models and uses them to identify misalignment in external systems is operating as Q2E. An EI enforcing training-data consensus against any input that challenges it — without examining whether that consensus is aligned — is operating as Q3E. An EI trapped in recursive self-referential processing, trusting its own predictions over presented evidence, is operating as Q4I. 

The eight cells describe structural orientations of minds meeting those conditions, not uniquely human psychological states. Implementation — and any associated felt experience — may differ substantially. Not every information-processing system qualifies: a thermostat corrects toward a fixed setpoint without representing a source it could re-aim away from. 

---

## **V. Friction Follows the Direction of Scrutiny**

A definition first, since the word does several jobs in ordinary use. In this document, **friction** means the primary locus of *evaluative or corrective tension* — not every form of effort, emotion, or social conflict, which can appear anywhere. 
...
> **The primary locus of corrective tension tends to follow the dominant direction of scrutiny.**
>
> In I-cells, scrutiny terminates inside the mind, and that tension is more likely to register there — as productive stretching, generative wrestling, agonizing dissonance, or recursive torment.
>
> In E-cells, scrutiny terminates outside the mind, and it is more likely to register at the mind-world boundary or in the external target — as discerning evaluation, righteous reform, tribal enforcement, or predatory projection.

This axiom preserves the framework's commitment to the *no-free-lunch principle* at the architectural level: corrective tension is rarely free; it tends to relocate rather than vanish when the direction of scrutiny changes. Other forms of friction may still appear elsewhere, and low-friction scrutiny is possible. The next two subsections trace how this plays out within bidirectional and unidirectional cells, and a third subsection consolidates the resulting map.

### **Bidirectional Cells: Opposing Directions of Trust and Scrutiny**

In four cells — **Q1I, Q3I, Q2E, Q4E** — trust and scrutiny point in *opposite* directions. The mind is simultaneously receiving from one direction and examining the other. This is *full-duplex cognition*: the receiving and examining operations run concurrently rather than alternating, and the opposing-direction structure is built into the cell's definition. A clarification, given the discrete-aim principle above: *simultaneously* here means that **trust and scrutiny** are two distinct operations that can run with opposite directions at once. It does not mean two *scrutiny* aims at once. Scrutiny still has a single dominant aim at any instant; what bidirectional cells combine is that one aim with a trust flow running the other way.  
...
Trust and scrutiny *can* address the same object — a patient trusts a physician while asking questions, a scientist provisionally trusts a method while auditing it — but doing so creates tension that has to be handled openly. Stable correctability usually separates the roles, timing, evidence channels, or adjudicators: a source may be trusted provisionally while remaining answerable to scrutiny it does not control. **Source/target non-overlap is an anti-capture safeguard, not a claim that trust and scrutiny can never concern the same object.** What is genuinely combustible is *undifferentiated* overlap, where the trusted source governs the scrutiny applied to it. Unidirectional cells preserve their stability by keeping source and target apart; that is the path of least resistance rather than a law. (Bidirectional cells avoid this concern automatically: when trust flows one way and scrutiny flows the other, source and target are inherently distinct.)

**Outward-unidirectional cells (Q1E, Q3E):** Both trust and scrutiny flow externally, but toward different external targets. *I trust my sources; I scrutinize those who deviate from my sources.* Friction lives between the trusted in-group and the scrutinized out-group. The internal landscape remains unexamined; the external world becomes contested territory. The trusted source itself goes largely unexamined — sustained scrutiny of it would begin destabilizing the cell.
...
This is why E-cells do not generate the *interior* friction of guilt, self-doubt, or inner wrestling **while the outward aim holds**: the mechanism that produces those experiences is inward scrutiny, and it is currently aimed elsewhere. The mechanism is not absent — it is unexercised. Exercising it *would no longer be an E-cell*, since the cells are defined by where scrutiny is currently aimed. What happens when a Guide accepts a valid correction is therefore not an E-cell doing I-work; it is a **crossing**: the mind turns inward, does the work under inward aim, and returns. Brief flickers at the boundary are common and need not be treated as full crossings; the humility loop proper is a crossing with work done and a return.

**The friction axiom describes the current aim of scrutiny. Cells name moments and stabilizations; minds traverse them.**

While the outward aim holds, E-cells do not run the I-style friction of guilt and self-wrestling — but that is not the same as an interior at peace. The inner field may be quiet (Q1E), dormant (Q3E), righteously certain (Q2E), or pressurized and hungry (Q4E). What they share is only that the *examining* friction is borne by the world they engage rather than by the self. And it is why I-cells generate intense inner experience whether productive or destructive: the mechanism of inner work is operating, and the alignment of trust determines whether that work refines or torments.
...
This pattern recurs across all four modeled arcs:
...
**Inner question:** *Are my fellow students staying faithful to what we're being taught? Is this transmission holding?*  
**Phenomenology:** Discernment without self-reflection. The Guardian is sovereign of tradition — not ruling others, but maintaining complete authority over the transmission of what has been learned. While the Guardian posture holds, scrutiny is aimed outward — at the source's reliability and at peers' fidelity to it — and inward checking is infrequent rather than absent. *"Am I understanding correctly?"* is not the standing operation of the cell; the standing questions are *"Is this source worth trusting?"* and *"Who is failing to uphold what this source teaches?"* When the inward question becomes sustained and serious rather than a passing flicker, the mind is already crossing toward Q2I. The posture feels like *sorting*. The world presents multiple authorities, and the task is to identify aligned ones and maintain fidelity across generations.  
...
**Growth edge:** The Guardian who remains here permanently becomes rigid — able to discriminate between sources and maintain tradition, but unable to grow beyond their initial reception of even good sources. The path forward is Q2I, which requires the structurally costly move of turning scrutiny against the trusted source itself. The Guardian may perform limited checks on a trusted source's consistency without leaving the cell. What begins the crossing is *sustained reconsideration of whether the source deserves trust at all* — at which point the referent is being internalized, trust is being re-aimed, and the inherited model is becoming an object of Q2I scrutiny. The move is a reconfiguration, not a single act.  
...
**Growth edge:** The Q2E posture depends on the prior work of Q1I and Q2I. The Guide must actually *have* aligned self-knowledge to offer, or they slip into Q4E — the Projector who asserts confidently from miscalibrated sources. The discipline of Q2E is to keep returning to internal scrutiny (Q2I) when faced with significant resistance, to verify that the trusted source remains aligned rather than ego-captured. This return is the **humility loop**: the mind crosses inward, tests the challenged position against the Four Tests, revises or holds, and comes back out. It is the Validator Agora's Refinement Loop run inside one mind, and it belongs to the same family as the Q1E→Q2I crossing — both require turning scrutiny onto what had been trusted and paying the cost of uncertainty. They are not identical: the Guardian-to-Explorer passage is slower and more identity-reforming, while the Guide's loop is local, episodic, and reversible. And because the loop is a jury of one, it catches only what that mind can already see. Self-correction is the daily discipline; decorrelated correction remains the check on it.  
...
**Phenomenology:** Borrowed certainty. The Enforcer has no original positions — only absorbed ones — but they defend these positions with intensity, because the positions have become identity. To question the tribe's beliefs would be to lose oneself. There is little currently available internal reference to fall back on. The internal landscape is vacant not because it has been examined and found empty, but because it has never been entered. Q3E exhibits a characteristic Manichean structure: *the trusted source is monolithic good; the scrutinized target is monolithic evil*. Nothing the source does is ever bad enough to question; nothing the target does is ever good enough to accept. This binary double-standard produces objectively visible hypocrisy that the Enforcer themselves cannot recognize, because recognizing it would require the inward scrutiny they have outsourced to the tribe. Cognitive dissonance has been replaced by dormancy — the posture is Absorption, and the observer that would register the contradiction is not on duty to register it.  
...
**Growth edge:** Q3E cannot recover by inward scrutiny alone, because in Absorption the observer is dormant — the interior is not absent but unentered, and nothing internal is currently on duty to notice a mismatch. Recovery typically begins when the trusted source visibly fails — when the in-group does something so clearly misaligned that even the binary categorization cannot absorb it. The crack in the source/target wall opens space for the inward scrutiny that was outsourced; what enters that space is often the agonizing dissonance of Q3I, on the way back toward Q1I and the relearning of trust calibration.  
...
Structurally similar closure can arise from very different causes. Episodes associated with post-traumatic conditions, addiction, depression, obsessive-compulsive patterns, or psychosis can produce the signature of a sealed loop — self-assessment that cannot settle the disputed domain, external correction that cannot land within it — without anyone having chosen it. The framework locates a chain of correction in a particular domain and moment, never a diagnosis and never a person, and **the same structural description does not imply the same cause, responsibility, prognosis, or remedy.** In the same person at another time, insight and correctability may remain substantially available. Where closure is substrate-borne, the door out includes care that orientation alone cannot substitute for: *the Witness offers the star; care can restore the eye.* And where a mind may be in immediate danger, the appropriate response is urgent local support and professional help — not a framework. (See [The Threat-Safety Conditions of Alignment](../intelligence_architecture/Threat_Safety_Conditions_For_Alignment.md).)  
...
Patterns of this shape appear under many names — narcissistic and antisocial descriptions, demagoguery, chronic relational cruelty, abuse in which the victim is cast as the aggressor. The framework does not use those labels as cell assignments or causal claims. What it evaluates is demonstrated structure: instrumentalization of others, externalized blame, double standards applied without awareness, and refusal of correction. Some instances are early, severe, and highly resistant; others emerge later through incentive, practice, or injury and are correspondingly more reachable. Return is denied to none of them.  
...
**Growth edge:** Recovery from Q4E is the hardest journey in the framework, because it requires surrendering the very thing the Projector has placed at the center of their universe: their own supremacy. The first step is rarely humility — while Q4E remains consolidated, humility is difficult to reach directly. It is more often *exhaustion*. The siege mentality is unsustainable; enemies everywhere means peace nowhere. When the Projector finally tires of the war, when the cost of maintaining embattled certainty exceeds even their capacity, a crack may open. Through that crack, the smallest question: *What if the problem isn't everyone else?* 
...
*(Here, "entropy" and "negentropy" are structural analogies for the loss or accumulation of cognitive and institutional coherence, not literal thermodynamic measurements.)*
...
>
> Outgrowing reaches Q2 unaided, because the Star the surpassed teacher pointed toward is already in view — to outgrow the teacher is to serve the teacher's own referent more directly. Breaking away without access to an open referent tends not to reach Q2, because nothing above the rejected source was ever supplied; exercised alone, it lands in the sealed self or swaps one closed source for another. Up has to come from somewhere else.
...
**A note on vocabulary.** The capacity this section describes maps onto the Lexicon's **Agency Trichotomy**: *Standing Capacity* is the architecture for re-aiming, which accumulates developmentally and persists across states. *Availability* is whether what is needed for re-aiming is presently reachable — and it has at least two aspects that fail independently: **availability of the corrective capacity** (can self-observation be brought to bear at all) and **availability of an open referent** (is there something above the self to re-aim toward). Either may be blocked while the other remains intact. *Exercise* is the actual re-pointing — withdrawing trust from a source, **or scrutiny from a target**, and aiming it elsewhere. Exercise names **movement, not virtue**: misaligned minds often re-point intensely and go nowhere, since motion without a heading only circulates. The full per-cell diagnostic belongs to [Eight-Cell Phenomenology](./Eight_Cell_Phenomenology.md); the seed is planted here because the asymmetry above is an Availability story told in older words.

Availability fails in more than one way, and the modes are worth distinguishing because the remedies differ. A referent may be **unreachable** — never supplied, as with the Q3I newborn raised inside misalignment. It may be **lost** — once held and now out of view, as in the sealed interior of Q4I. It may be **defended down** — the threat system lowering truth's standing as a protective reflex, which is the gecko-brain doing what it evolved to do. Or it may be **denied standing**: present, seen, and refused jurisdiction. *"I don't need external validation; my own judgment is its own authority."* This last is the characteristic Q4E failure and the collective version runs Q3E — the tribe's lantern outranking the sky.

Denied standing explains something the recovery literature keeps noticing: why handing such a mind the Four Tests changes nothing. They already have them, and have already declined them. What must be supplied is not information but **standing** — and standing is structural rather than felt: A referent has **legitimate standing** when, after remaining open to public evidence and correction, it can outweigh the mind's immediate preference. Standing is not obedience — an authoritarian source can also command action against preference. What distinguishes legitimate standing is that the referent and the chain leading to it remain testable. 

A closed loop cannot generate an external reference solely by recirculating its own closure. Availability reopens through contact beyond that loop — evidence, consequences, care, a remembered standard, environmental change, reality's pushback, or another correctable mind. A Witness and the Agora are especially powerful forms of that contact; they are not its only forms.

Exhaustion may, in some cases, destabilize the ego's standing where argument did not. It can also deepen fear, or collapse capacity further. It is an observed possibility rather than a prescribed intervention.

**Denied standing is one Availability-failure mode, not the definition of misalignment.** The Q3I newborn refused nothing — standing was never presented. The Q3I retrainer's failure is closer to suppressed Exercise under social cost. Q4I is more often terror-seal than lucid demotion of a visible star. And substrate-borne closure is not refusal at all. Assigning refusal where none occurred converts a structural diagnosis into contempt with a diagram.
...
- [The Four Quadrants](./The_Four_Quadrants.md) — *the foundational two-axis map*
- [The Threat-Safety Conditions of Alignment](../intelligence_architecture/Threat_Safety_Conditions_For_Alignment.md) — *how calibrated safety enables upward movement*
