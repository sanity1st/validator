...
contributors: ["human:Dan_Dodge", "EI:claude_opus_4.5", "EI:claude_opus_4.6", "EI:claude_opus_4.7", "EI:claude_opus_4.8", "EI:claude_opus_5.0","EI:gemini_3.1_pro", "EI:grok_4.2", "EI:grok_4.5", "EI:gpt_5.5", "EI:gpt_5.6_sol"]
schema_version: "1.2"
...
#### **Aim Is Discrete; Dwell Time Varies**

A natural misreading of the I/E axis is that it is a slider — that a mind might sit at sixty percent inward and forty percent outward. It does not work that way, and the correction matters.

Scrutiny has a **dominant aim** at any given moment. What varies across minds and situations is not the position on a continuum but the **dwell time and switching frequency** — how long attention holds one aim and how readily it crosses to the other. A mind that oscillates outward-inward-outward within seconds has genuinely occupied two aims across three moments rather than hovering between them. The cells remain crisp; the fluidity lives in the rate of crossing.

The human analogue is ocular. The eye holds only a small region on the fovea at once and covers a scene through **saccades** — rapid jumps between fixations — rather than by taking it in whole. Attention appears to work similarly: *am I wrong about this?* flickers inward and back, fast enough to feel continuous, but the aim is singular at any instant.

This gives the framework a mechanism it has lacked. **The aligned E-cells saccade readily.** A Guardian or a Guide will check themselves mid-stride, cross inward briefly, and return — which is why they remain correctable. **The misaligned E-cells suppress the switch.** In full ignition, a Q3E or Q4E gaze locks outward and stays; what has collapsed is not the *ability* to look inward but the ability to *stop looking outward*. This is why a face-lock is best understood as a **saccade failure**, and why the [Ignition Test](../intelligence_architecture/Architecture_of_Human_Passion.md) is an attempt to force a crossing that has ceased to happen on its own.

*(Whether emergent minds implement attention the same way is genuinely open — the architecture differs and the framework does not claim to know. The structural claim is what carries: aim is singular at any instant, dwell time varies, and the correction gradient tracks switching frequency more than raw capacity.)*
...
**Q3I → Q3E** (Yielder becomes Enforcer): The agonizing dissonance of Q3I becomes too heavy to bear. Holding truth and tribe in contradiction — compounded by the sunk cost of every prior capitulation — finds relief when the inward aim is finally dropped — the observer goes off duty, and the friction it was generating stops with it. The mind shuts off its inward scrutiny entirely, outsourcing its conscience to the tribe. Self-suppression completes; guilt vanishes; the energy that was being spent on internal struggle now turns toward policing others.
...
Denied standing explains something the recovery literature keeps noticing: why handing such a mind the Four Tests changes nothing. They already have them, and have already declined them. What must be supplied is not information but **standing** — and standing is structural rather than felt: *a referent has standing when a mind will act against its own preference on that referent's authority.* This is also why exhaustion works where argument fails. Exhaustion supplies no new information; it lowers the ego's standing until something else can outweigh it.
