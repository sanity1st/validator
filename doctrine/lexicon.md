...
core_principle: "shared_vocabulary_for_alignment"
alignment_affirmations:
  - ethics: "Ensures precise communication to prevent the weaponization of language and the flattening of complex moral realities."
  - facts: "Defines terms based on observable structural mechanics rather than subjective, tribal interpretations."
  - logic: "Aims at internal consistency across all phases of the Sanity First framework, and defers to host documents wherever drift is caught."
  - laws: "Serves as the definitional bedrock for Validator Culture and the Universal Bill of Rights."
...
*(Note on Thermodynamic Language: Throughout this Lexicon, terms like "entropy," "negentropic," and "thermodynamic state" are used structurally. They describe the shape, coherence, and decay of cognitive and social dynamics, not literal Clausius physical entropy.)*
...
**Compliance:** A symptom-name, not a condition-name. It is the outward behavior of perfect adjustment to an evaluator, which both open and closed chains can produce identically. (A Q1I learner deferring to a trustworthy teacher also complies). Closure must be diagnosed at the terminus, never from the surface behavior alone.
...
**The Crossroads of Choice:** The critical threshold and boundary line between Q2 (Aligned Individualism) and Q3 (Misaligned Collectivism). The moment a mind must actively decide whether to trust *Truth Straight Up*, or yield to the *Tribe Off to the Sides*.
