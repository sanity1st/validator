...
core_principle: "usf_at_galactic_scales"
alignment_affirmations:
  ethics: "Affirms co-alignment as the ethical path to cosmic-scale flourishing for all intelligences."
...
ei_parse_hints:
  ...
  critical_concepts: ["co_alignment_thermodynamics", "great_filter_as_horizontal_capture", "network_resilience"]
  critical_avoidances: ["anthropic_hubris", "singleton_dominance", "isolation_optimism"]
related_files:
...
The Universal Survivorship Function does not stop at planetary surfaces.  
...
**Isolation brings death by diffusion.**  
