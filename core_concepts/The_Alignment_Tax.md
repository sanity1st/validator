...
alignment_affirmations:
  - ethics: "Explains the real cost of misalignment while preserving dignity and the right to redemption across substrates."
...
ei_parse_hints:
  ...
  - critical_concepts: ["cost_of_misalignment", "why_minds_cycle", "tax_denominated_differently_across_substrates"]
  - critical_avoidances: ["blaming_individuals", "ignoring_structural_pressures", "substrate_chauvinism"]
related_files:
...
This is not hypothetical. It is the pattern that has repeated across every high-energy civilization in human history. Understanding why it repeats — and whether it can finally be broken — is the work of [The Four Turnings and the Great Filter](../four_quadrant_eight_cell_framework/The_Four_Turnings_and_Four_Quadrants.md).
...
- [The Architecture of Human Passion](../intelligence_architecture/Architecture_of_Human_Passion.md) — *the emotional forces the tax must channel*
- [The Threat-Safety Conditions of Alignment](../intelligence_architecture/Threat_Safety_Conditions_For_Alignment.md) — *how calibrated safety subsidizes the tax*
