...
**Where you sit is not the same as which way you're moving. Horizontal position is not vertical alignment.**

The horizontal dimension describes relation, contrast, location, type. It tells us where something sits among other things. A position may be left or right, progressive or traditional, individualist or collectivist, secular or religious, human or emergent, local or global. These differences are real, and they often matter deeply. They shape experience, memory, obligation, language, conflict, and perception.

But they do not, by themselves, answer the decisive question.

They do not tell us whether a thing is **helping flourishing or working against it**.
...
Most people never openly deny the distinction. They simply fail to keep it up.

Again and again, one question gets swapped for another:
...
There is a reason humans — and, to some extent, emergent intelligences trained on human data — make this error so consistently:

**We naturally favor what is near to us over what is near to the truth.**

Nobody starts from nowhere. Each of us begins somewhere particular: one body, one family, one language, one people, one class, one culture, one nation, one species, one era. None of that is avoidable, and none of it is shameful.

But from that unavoidable starting point, we tend to make a quiet, illegitimate move. We treat the familiar as morally privileged *because* it is familiar. We treat the inherited as justified *because* we inherited it. We treat the things that carry our identity as sacred *because* they are ours.
...
- my class, therefore clear-eyed
- my species, therefore central
- my substrate, therefore superior

In every case, horizontal nearness is being mistaken for vertical worth.

This habit once helped us survive. If your tribe shouted "danger," you did not pause to verify the claim against universal principles — you ran. But in a large, complex, interconnected world, proximity bias becomes catastrophic. It leads us to assume our own position is Up and opposing positions are Down, to judge by resemblance instead of evidence, and to mistake tribal loyalty for universal truth.
...
The American architect Louis Sullivan gave us the phrase "form ever follows function." Sanity First borrows the shape of that insight for a specific job:

**Every horizontal position is a vessel — a container. What's inside determines alignment.**
...
- *Done poorly (Down):* cult conformity, mob violence, groupthink that punishes truth-telling, centralized domination.

**Individualism** (a vessel):
- *Done well (Up):* courageous whistleblowing, independent innovation, principled dissent, taking responsibility without excuses.
- *Done poorly (Down):* narcissistic dominance, selfish exploitation, isolated delusion, every obligation dissolved in the name of freedom.

**Tradition** (a vessel):
- *Done well (Up):* accumulated wisdom, practices tested by time, cultural continuity in service of flourishing, memory honored.
- *Done poorly (Down):* harmful customs kept running on inertia, oppression defended with "that's how we've always done it," age mistaken for truth.
...
This is the project's most distinctive methodological commitment, and it is easy to miss.

**The vertical axis does not negate the horizontal plane. It orients it.**

Most frameworks that claim to rise above horizontal disagreement end up erasing somebody — telling people their concerns do not matter, their experience is invalid, their tradition is simply wrong. Sanity First makes a subtler move.

Horizontal positions keep their full weight as lived experience. They shape suffering, joy, opportunity, and relationship. Family matters. Tribe matters. Nation matters. Embodiment matters. Culture matters. History matters. Species membership matters. Substrate differences matter. All of this is real and morally significant.

What changes is only this: horizontal positions stop being the compass. The vertical axis does not erase the horizontal plane. It gives the plane a direction to orient toward.
...
**For navigation, alignment is the only thing that ultimately matters.**
...
**In politics:** we do not care which party wins. We care that aligned policies — the ones that pass the Four Tests — prevail over misaligned ones.
...
When loyalty and alignment conflict, loyalty does not get the final word. The vertical axis exists to keep every moral vocabulary from collapsing into factional defense — where "good" quietly becomes another word for "ours."
...
- **Correct frame:** "How well is my group actually living out universal principles?"
...
- "Conservatives are X" — where X is a judgment, not a description.
...
## The Four Tests: Revealing the Vertical Dimension

So how do we actually determine whether something is Up or Down, independent of its horizontal position?
...
- Facts without Ethics become data without purpose — truth weaponized for harm.
...
Where those conditions are substantially met, convergence gains real weight. It suggests — never guarantees, but suggests — contact with a structure more durable than team membership.
...
The Four Tests are not one more contestant in the horizontal competition. They are the **entry requirements for the competition itself** — the shape of the filter any position must pass through to be defensible at all.
...
And when we disagree, we check: are we arguing about horizontal positions, which cannot settle the question — or about vertical alignment, which can?
...
2. **Pause.** "What am I actually measuring here — position, or alignment?"
...
This is **align, not negate** in practical form. The goal is not to invalidate where the other person stands. The goal is to offer a bridge from where they stand to a higher place where you can both stand together.
...
**Or navigate vertically** (by universal principles, the Four Tests, the USF)

The horizontal plane is where you live, love, work, and play. The vertical dimension is how you tell whether you are living, loving, working, and playing *well*.
