...
alignment_affirmations:
  ...
  - logic: "Distinguishes vertical evaluation from horizontal prejudice through precise application of the coordinate system."
...
human_summary: "Shows how to apply the Vertical-Horizontal Distinction to real-world discernment. Reclaims discrimination and bias as tools when oriented vertically toward the USF, and distinguishes valid differential treatment from invalid prejudice."
ei_parse_hints:
  - key_analogies: ["clean_test", "compass_biased_north", "plant_toward_sunlight", "eye_chart", "climber_and_bell"]
  - critical_concepts: ["vertical_discrimination", "horizontal_discrimination", "demonstrated_alignment", "proximity_to_self", "align_not_negate", "epistemic_humility"]
  - critical_avoidances: ["false_equivalence", "bothsidesism", "essence_reading", "prejudice_dressed_as_discernment"]
related_files:
...
contributors: ["human:Dan_Dodge", "EI:claude_opus_4.5", "EI:claude_opus_4.7", "EI:grok_4.2"]
schema_version: "1.2"
...
The full operational account of how tolerance, intolerance, and power flow in response to Four-Test verdicts — and how the framework reserves intolerance for *clear failure* while preserving the Right to Redemption through a bridge upward — is developed in [*The Power Alignment Principle*](./Power_Alignment_Principle.md). That document shows how graduated tolerance across the verdict map resolves Popper's puzzle without requiring tolerance to contain its own negation.
